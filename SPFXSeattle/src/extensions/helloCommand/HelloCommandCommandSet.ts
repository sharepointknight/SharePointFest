...
import * as strings from 'helloCommandStrings';
 ...
 */
export interface IHelloCommandCommandSetProperties {
  // This is an example; replace with your own property
  disabledCommandIds: string[];
}

const LOG_SOURCE: string = 'HelloCommandCommandSet';

export default class HelloCommandCommandSet
  extends BaseListViewCommandSet<IHelloCommandCommandSetProperties> {

  @override
  public onInit(): Promise<void> {
    Log.info(LOG_SOURCE, 'Initialized HelloCommandCommandSet');
